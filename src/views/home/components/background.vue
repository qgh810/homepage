...
export default {
  ...
  mounted () {
    // 只有在webkit内核才使用背景动画
    !browser.versions.mobile && browser.versions.mac && browser.versions.chrome && this.addEventListener()
  },

  beforeDestroy () {
    // 移除鼠标事件
    this.mousemoveEvent && document.removeEventListener('mousemove', this.mousemoveEvent)
  },
